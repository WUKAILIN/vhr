...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    HrService hrService;
    @Autowired
    CustomUrlFilterConfig filterConfig;
    @Autowired
               ...
               // .anyRequest().authenticated()
                .withObjectPostProcessor(new ObjectPostProcessor<FilterSecurityInterceptor>() {
                    ...
                    public <O extends FilterSecurityInterceptor> O postProcess(O obj) {
                        obj.setSecurityMetadataSource(filterConfig);
                        obj.setAccessDecisionManager(decisionManager);
                        return obj;
                    }
                })
                .and()
                ...
                .successHandler(new AuthenticationSuccessHandler() {
                    ...
                    public void onAuthenticationSuccess(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws IOException, ServletException {
                        ...
                        hr.setPassword(null);
                        ResponseBean ok = ResponseBean.responseSuccess("登录成功!", hr);
                ...
                .failureHandler(new AuthenticationFailureHandler() {
                    ...
                    public void onAuthenticationFailure(HttpServletRequest req, HttpServletResponse resp, AuthenticationException exception) throws IOException, ServletException {
                        resp.setContentType("application/json;charset=utf-8");
                        PrintWriter out = resp.getWriter();
                        ResponseBean respBean = ResponseBean.responseError("登录失败!");
                ...
                .logoutSuccessHandler(new LogoutSuccessHandler() {
                    ...
                    public void onLogoutSuccess(HttpServletRequest req, HttpServletResponse resp, Authentication authentication) throws IOException, ServletException {
                        resp.setContentType("application/json;charset=utf-8");
                        PrintWriter out = resp.getWriter();
                        out.write(new ObjectMapper().writeValueAsString(ResponseBean.responseSuccess("注销成功!")));
                        out.flush();
                        out.close();
                    }
                })
                ...
                .authenticationEntryPoint(new AuthenticationEntryPoint() {
                    ...
                    public void commence(HttpServletRequest req, HttpServletResponse resp, AuthenticationException authException) throws IOException, ServletException {
                        ...
                        resp.setStatus(401);
                        PrintWriter out = resp.getWriter();
                        ResponseBean respBean = ResponseBean.responseError("访问失败!");
